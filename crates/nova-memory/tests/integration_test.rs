//! Full end-to-end integration tests for Nova Memory proxy flow
//!
...
mod full_proxy_flow_tests {
    ...
    async fn test_end_to_end_memory_flow() {
        ...
        assert!(
            memory_block.contains("<nova-memories>"),
        ...
        assert!(
            system_content.contains("<nova-memories>"),
...
mod full_pipeline_tests {
    ...
    async fn test_complete_memory_pipeline() {
        ...
        assert!(system_msg.contains("<nova-memories>"));
