...
impl Tombstone {
    ...
    /// ```xml
    /// <mnemo-tombstone timestamp="2024-01-15" topics="project-x, alice">
    ...
    pub fn to_xml(&self) -> String {
        ...
        format!(
            r#"<mnemo-tombstone timestamp="{timestamp}" topics="{topics_str}">
  {content}
</mnemo-tombstone>"#
        )
    }
